SmolGame — **мини-игры в Telegram**: вертикальная лента, как короткие ролики, только вместо видео — **браузерные HTML5-игры**. Свайп — следующая игра, **«Играть»** — во весь экран. **Свою** игру можно выложить по ссылке или через GitHub (вкладка «Загрузить» внизу).
