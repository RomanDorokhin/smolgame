...
import { Menu, Github, Layout, MessageSquare, Play, Pencil, RotateCcw, X, ChevronDown, ChevronUp, Key, Trash2, Save, FileCode, Monitor, Smartphone, Maximize2, ExternalLink, ArrowLeft, Wand2, LoaderCircle as Loader2, CircleCheck as CheckCircle2, EllipsisVertical as MoreVertical, Sparkles as SparkleIcon } from "lucide-react";
...
export default function Home() {
  ...
  const GENRE_PRESETS = [
    { title: "Бесконечный Раннер", emoji: "🏃", prompt: "Создай бесконечный раннер в стиле киберпанк с неоновыми цветами. Игрок управляет персонажем тапами по экрану (прыжки). Нужно уворачиваться от препятствий и собирать монеты. Добавь сочные эффекты частиц и вибрацию при столкновении." },
    { title: "Tower Defense", emoji: "🏰", prompt: "Сделай мобильную Tower Defense игру. Враги идут по тропинке, игрок ставит башни через удобное меню тапами. Башни стреляют автоматически. Полностью сенсорный интерфейс." },
    { title: "Кликер (Idle)", emoji: "👆", prompt: "Создай залипательный мобильный кликер про добычу кристаллов. По центру огромный кристалл, реагирующий на тапы. За нажатия дают валюту, на которую можно покупать улучшения. Добавь много визуального фидбека на каждое нажатие." },
    { title: "Головоломка 2048", emoji: "🧩", prompt: "Напиши клон 2048 с управлением свайпами (сенсор). Красивые анимации слияния плиток и современная мобильная палитра." },
    { title: "Космический Шутер", emoji: "🚀", prompt: "Космический шутер. Корабль следует за пальцем игрока (сенсорное управление). Стрельба автоматическая. Враги наступают волнами, сочные взрывы и бонусы." },
    { title: "Платформер", emoji: "🍄", prompt: "Мобильный 2D платформер. Добавь на экран крупные удобные кнопки для управления (влево, вправо, прыжок). Персонаж собирает ключи. Сделай управление отзывчивым для телефона." },
