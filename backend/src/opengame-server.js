...
2. MOBILE & DESKTOP CONTROLS (CRITICAL): The game runs in an iframe. You MUST add BOTH 'window.addEventListener("touchstart", ...)' AND 'window.addEventListener("mousedown", ...)' for all player actions (jumping, moving, etc). If you only use 'keydown', the game is UNPLAYABLE and you fail the task.
