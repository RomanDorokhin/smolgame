...
const CLICK_ACTIONS = {
  ...
  'report-game':    () => openReportScreen(),
  'close-report':   () => closeReportScreen(),
  'submit-report':  () => submitReportFromScreen(),
  ...
  'admin-dismiss-report': (el) => adminDismissReport(el.closest('.admin-card')),
