/**
 * features/feed/feed.js
 * 
 * Управление вертикальной лентой мини-игр (TikTok-style).
 * Отвечает за бесконечный скролл, загрузку карточек, виртуализацию iframe 
 * и объединение основной выдачи с очередью модерации для админов.
 * 
 * Зависимости: core/state.js, core/api.js, modules/events.js
 */
